 ...
 */
final class Version20260121124254 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_variant_option DROP FOREIGN KEY FK_1CB5D94AA80EF684');
        $this->addSql('ALTER TABLE product_variant_option ADD CONSTRAINT FK_1CB5D94AA80EF684 FOREIGN KEY (product_variant_id) REFERENCES product_variant (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
    }
}
